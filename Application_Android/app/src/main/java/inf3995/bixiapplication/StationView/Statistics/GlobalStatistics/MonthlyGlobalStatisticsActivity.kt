...
class MonthlyGlobalStatisticsActivity : AppCompatActivity() {
    ...
    private val TAG = "Monthly Global Statistics"
    ...
    private fun requestToServer(ipAddress: String?) {
        ...
        call.enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>?, response: Response<String>?) {
                Log.i(TAG, "Response Status  of Monthly Global statistics  from Server: ${response?.code()}")
                Log.i(TAG, "Response body of Monthly Global statistics from Server: ${response?.body()}")
            ...
            override fun onFailure(call: Call<String>?, t: Throwable) {
                ...
                val builder = AlertDialog.Builder(this@MonthlyGlobalStatisticsActivity)
