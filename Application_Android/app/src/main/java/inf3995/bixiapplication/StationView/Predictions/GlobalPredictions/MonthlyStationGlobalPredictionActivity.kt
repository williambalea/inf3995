...
class MonthlyStationGlobalPredictionActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_monthly_station_prediction_global)
    ...
    private fun requestToServer(ipAddress: String?) {
        ...
        call.enqueue(object : Callback<String> {
            ...
            override fun onFailure(call: Call<String>?, t: Throwable) {
                ...
                val builder = AlertDialog.Builder(this@MonthlyStationGlobalPredictionActivity)
